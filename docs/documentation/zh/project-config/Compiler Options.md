...
- Learn how to use a [`tsconfig.json`](/zh/docs/handbook/tsconfig-json.html) file.
- Learn how to work in an [MSBuild project](/zh/docs/handbook/compiler-options-in-msbuild.html).
