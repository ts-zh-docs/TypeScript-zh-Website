...
With more `tsconfig.json` files, you'll usually want to use [Configuration file inheritance](/zh/docs/handbook/tsconfig-json.html) to centralize your common compiler options.
